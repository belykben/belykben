...
# ===========================================================================
HOST = "belykben"   # shown as  belykben@github  in the header
...
ROWS = [
    ...
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Backend",  "Python, FastAPI, REST, Celery"),
    ("kv", "Frontend", "React, Angular, TS, Tailwind, MUI"),
    ("kv", "AI/LLM",   "LangGraph, RAG, vLLM, Qwen, Neo4j"),
    ("kv", "Infra",    "Postgres, Redis, Kafka, Docker, K8s"),
    ("gap",),
    ("sec", "Highlights"),
